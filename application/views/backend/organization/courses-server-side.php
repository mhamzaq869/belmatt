        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('courses'); ?>
                    <a href="<?php echo site_url('organization/course_form/add_course'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_new_course'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
        ...
        <div class="card widget-inline">
            <div class="card-body p-0">
                <div class="row no-gutters">
                    ...
                    <div class="col">
                        <a href="<?php echo site_url('organization/courses?category_id=all&status=upcoming&instructor_id=all&price=all&button='); ?>" class="text-secondary">
                    ...
                    <div class="col">
                        <a href="<?php echo site_url('organization/courses?category_id=all&status=pending&instructor_id=all&price=all&button='); ?>" class="text-secondary">
                            <div class="card shadow-none m-0 border-left">
                                <div class="card-body text-center">
                                    <i class="dripicons-link-broken text-muted" style="font-size: 24px;"></i>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row justify-content-center" action="<?php echo site_url('organization/courses'); ?>" method="get">
                    <!-- Course Categories -->
                    <div class="col-xl-3">
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            ...
                            <select class="form-control server-side-select2" name="instructor_id" id='instructor_id' action="<?php echo site_url('organization/get_select2_instructor_data/all'); ?>">
