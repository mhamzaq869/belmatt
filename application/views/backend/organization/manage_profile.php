		...
		<div class="card">
			<div class="card-body">
				...
				foreach($edit_data as $row):
					...
					<?php echo form_open(site_url('organization/manage_profile/update_profile_info/'.$row['id']) , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
