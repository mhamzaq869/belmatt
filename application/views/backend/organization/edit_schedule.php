                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="col-lg-12">
                                                ...
                                                <!-- <label><?php //echo get_phrase('End Time'); 
                                                            ?></label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" data-toggle='timepicker'id="end_time" name="end_time[]">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i class="dripicons-clock"></i></span>
                                                        </div>
                                                    </div> -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        var value = '<?php if (isset($schedule_details) && is_array($schedule_details) && array_key_exists(0, $schedule_details)) echo $schedule_details[0]['tuition_type'];
                        ?>';
