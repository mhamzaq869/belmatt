                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form class="required-form"
                            action="<?php echo site_url('admin/course_actions/add'); ?>"
                            method="post" enctype="multipart/form-data">
                            <div class="scrollable-tab-section" id="basicwizard">

                                <button type="button" class="scrollable-tab-btn-left"><i
                                    ...
                                    <ul class="nav nav-pills nav-justified form-wizard-header"
                                        ...
                                        <li class="nav-item">
                                            <a href="#basic" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                ...
                                                <span
                                                    class=""><?php echo get_phrase('basic'); ?></span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#info" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                ...
                                                <span
                                                    class=""><?php echo get_phrase('info'); ?></span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="#seo" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                ...
                                                <span
                                                    class=""><?php echo get_phrase('seo'); ?></span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#finish" data-toggle="tab" class="nav-link rounded-0 pt-2 pb-2">
                                                ...
                                                <span
                                                    class=""><?php echo get_phrase('finish'); ?></span>
                                            </a>
                                        </li>
                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2"
                                                            ...
                                                            <option value="scorm">
                                                                <?php echo get_phrase('scorm'); ?>
                                                            </option>
                                                            <?php } ?>
                                                            <?php if (addon_status('h5p')) { ?>
                                                            <option value="h5p">
                                                                <?php echo get_phrase('H5P'); ?>
                                                                <?php } ?>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="profession"><?php echo get_phrase('profession'); ?></label>
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2"
                                                            name="profession[]" id="profession" multiple>
                                                            <option value="nurses">Nurses</option>
                                                            <option value="doctors">Doctors</option>
                                                            <option value="paramedics">Paramedics</option>
                                                            <option value="pharmacists">Pharmacists</option>
                                                            <option value="allied-healthcare-professionals">Allied
                                                                Healthcare Professionals</option>
                                                            <option value="healthcare-assistants">Healthcare Assistants
                                                            </option>
                                                            <option value="managers">Managers</option>
                                                            <option value="admin-staff">Admin Staff</option>
                                                            <option value="physician-assistants">Physician Assistants
                                                            </option>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label"
                                                        for="Type"><?php echo get_phrase('Type'); ?></label>
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" name="type[]" id="type"
                                                            multiple="multiple">
                                                            <option value="e-learning">
                                                                <?php echo get_phrase('E-Learning'); ?>
                                                            </option>
                                                            <option value="live-webinar">
                                                                <?php echo get_phrase('Live Webinar'); ?>
                                                            </option>
                                                            <option value="classroom">
                                                                <?php echo get_phrase('Classroom'); ?>
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="address d-none">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" id="course_country"
                                                                name="country"
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" id="course_state"
                                                                name="state"
                                                                placeholder="<?php echo get_phrase('enter_country_name'); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" id="course_city"
                                                                name="city"
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control" id="course_address"
                                                                name="address"
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-10">
                                                            <input type="text" class="form-control"
                                                                id="course_postal_code" name="postal_code"
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2"
                                                            ...
                                                            <option value="youtube">
                                                                <?php echo get_phrase('youtube'); ?>
                                                            </option>
                                                            <option value="vimeo">
                                                                <?php echo get_phrase('vimeo'); ?>
                                                            </option>
                                                            <option value="html5">
                                                                <?php echo get_phrase('HTML5'); ?>
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
        ...
        if (discounted_price > 0) {
            ...
            if (actualPrice > 0) {
                ...
                if (discountedPercentage > 0) {
                    ...
                    jQuery('#discounted_percentage').text(
                        '<?php echo '0%'; ?>');
                }
            }
        }
