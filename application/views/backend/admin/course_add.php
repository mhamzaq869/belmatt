                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="address d-none">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="course_country" name = "country" placeholder="<?php echo get_phrase('enter_country_name'); ?>">
                                                    </div>
                                                </div> 
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="State"><?php echo get_phrase('State'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="course_state" name = "state" placeholder="<?php echo get_phrase('enter_country_name'); ?>">
                                                    </div>
                                                </div> 
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="City"><?php echo get_phrase('City'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="course_city" name = "city" placeholder="<?php echo get_phrase('enter_city_name'); ?>">
                                                    </div>
                                                </div> 
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="Address"><?php echo get_phrase('Address'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="course_address" name = "address" placeholder="<?php echo get_phrase('enter_address'); ?>">
                                                    </div>
                                                </div> 
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="Postal Code"><?php echo get_phrase('Postal Code'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" id="course_postal_code" name = "postal_code" placeholder="<?php echo get_phrase('enter_postal_code'); ?>">
                                                    </div>
                                                </div>   
                                                <div class="form-group row mb-3">
