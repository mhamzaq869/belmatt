	...
	<body style="background-color: #fff !important;">
		...
		<script>
			...
			"handler": function (response){
		        ...
		        var redirectUrl = "<?php echo site_url('addons/ebook/razorpay_payment/'.$ebook_id.'?user_id='.$user_details['id'].'&amount='.$amount_to_pay.'&razorpay_order_id='); ?>" + response.razorpay_order_id + "&payment_id=" + response.razorpay_payment_id + "&signature=" + response.razorpay_signature;
