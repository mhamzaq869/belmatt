...
<?php $custom_page_menus = $this->crud_model->get_custom_pages('', 'header'); ?>
      ...
      <div class="right-menubar ms-auto">
        ...
        <?php if(!$user_id): ?>
          ...
          <a href="<?php echo site_url('sign_up'); ?>" class="mx-3 text-capitalize"> <?php echo get_phrase('Join Now'); ?></a>
        <?php endif; ?>
          ...
          <?php if($user_login || $admin_login): ?>
            ...
            <div class="menu_pro_tgl_div">
              <div class="menu_pro_tgl-2div">
                <a class="menu_pro_tgl profile-dropdown"><img src="<?php echo $this->user_model->get_user_image_url($user_id); ?>" /></a>
              </div>
