...
<link rel="stylesheet" href="<?php echo base_url() . 'assets/frontend/default-new/tutor_booking/new/css/vendors/slick.css'; ?>">
                ...
                <div class="tab-content tutor-tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="schedule-tab-pane" role="tabpanel" aria-labelledby="schedule-tab" tabindex="0">
                        ...
                        <div class="courseAvailability">
                            ...
                            <a href="#" class="availabilityBtn mt-40" data-bs-toggle="modal" data-bs-target="#availabilityModal"><?php echo get_phrase('View all availability')?></a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="sRequest-lesson">
                    <form action="<?php echo site_url('addons/tutor_booking/book_a_schedule'); ?>" class="sRequest-form" method="post" name="tution_form" onsubmit="return validateForm()">
                        <div class="mb-20">
                            <label for="subject_book" class="form-label"><?= get_phrase('Subject'); ?></label>
                            <input type="text" class="form-control" id="subject_book" placeholder="Subject Name" readonly />
                        </div>
                        <div class="mb-20">
                            <label for="title_book" class="form-label"><?= get_phrase('Title'); ?></label>
                            <input type="text" class="form-control" id="title_book" placeholder="Topic title" readonly />
                        </div>
                        <div class="mb-20">
                            <label for="classs" class="form-label"><?= get_phrase('Class type'); ?></label>
                            <input type="text" class="form-control" id="classs" placeholder="Type of class " readonly />
                        </div>
                        <div class="mb-20">
                            <label for="Price" class="form-label"><?= get_phrase('Price'); ?></label>
                            <input type="text" class="form-control" id="Price" placeholder="Price" readonly />
                        </div>
                        <div class="">
                            <label for="current_date" class="form-label"><?= get_phrase('Date & Time'); ?></label>
                            <input type="text" class="form-control" id="current_date" name="current_date" placeholder="Select date & time" aria-label="Select date & time" data-bs-toggle="modal" data-bs-target="#availabilityModal" />
                        </div>
                        ...
                        <button type="submit"  class="sRequest-btn w-100 border-0"><?php echo get_phrase('Request lesson'); ?></button>
                    </form>
                </div>
            </div>
        </div>
