        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 col-12 "> 
                <div class="sing-up-right">
                    ...
                    <p><?php echo ucwords(get_phrase('Explore, learn, and grow with us. Enjoy a seamless and enriching educational journey. Lets begin!')) ?></p>
        ...
        <input class="form-control" id="organisations" type="text" name="organisations" placeholder="<?php echo get_phrase('Enter your organisation'); ?>" required>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="position-relative">
                                ...
                                <input class="form-control" id="password" type="password" name="password" placeholder="<?php echo get_phrase('Enter password'); ?>" required>
                            </div>
                        </div>
                        
                        <div class="mb-4">
                            <h5><?php echo get_phrase('Sign up As') ?></h5>
                            <select class="form-control select2" name="signupType" id="signupType">
                                ...
                                <option value="organization"><?php echo get_phrase('Organisation'); ?></option>
                            </select>
                        </div>
                    ...
                    <div class="another text-center">
                        <p>
                            <?php echo get_phrase('Already have an account?') ?>
                            <a href="<?php echo site_url('login') ?>"><?php echo get_phrase('Login') ?></a>
                        </p>
