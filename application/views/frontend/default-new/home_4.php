...
<section class="banner">
  <div class="banner-wrap" style="background-image: url('<?php echo base_url("uploads/system/" . get_current_banner('banner_image')); ?>');">
            ...
            <h4 class="title">
              <?php
                foreach($banner_title_arr as $key => $value){
                    if($key == 0){
                        echo '<span class="graphic-1"><img src="'.site_url('assets/frontend/default-new/').'image/graphic-2.png" alt="" /></span> '.$value.'<br>';
                    }elseif($key == 1){
...
<style>
  ...
  .banner-wrap {
    ...
    min-height: 600px; /* Set an appropriate height for your hero section */
  }
    ...
    <div class="row">
      <div class="col-lg-4 col-sm-6">
        <div class="service-item-one">
          <div class="icon"><img src="<?php echo site_url('assets/frontend/default-new/') ?>image/icon/video-editing.svg" alt="" /></div>
            <?php
      ...
      <div class="col-lg-4 col-sm-6">
        <div class="service-item-one">
          <div class="icon"><img src="<?php echo site_url('assets/frontend/default-new/') ?>image/icon/retouching.svg" alt="" /></div>
      ...
      <div class="col-lg-4 col-sm-6">
        <div class="service-item-one">
          <div class="icon"><img src="<?php echo site_url('assets/frontend/default-new/') ?>image/icon/color.svg" alt="" /></div>
      ...
      foreach ($top_courses as $key => $top_course) :
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($top_course['title'])) . '/' . $top_course['id']); ?>" class="course-item-one">
            <div class="img-rating">
              <div class="img"><img src="<?php echo $this->crud_model->get_course_thumbnail_url($top_course['id']); ?>" alt="" /></div>
              <div class="rating">
                <p class="no"><?php echo $average_ceil_rating; ?></p>
                <span><img src="<?php echo site_url('assets/frontend/default-new/') ?>image/icon/star.svg" alt="" /></span>
              </div>
            </div>
            <div class="content">
                ...
                <div class="view-play">
                  <div class="item">
                    <div class="icon" title="<?php echo get_phrase('Number of enrolled students'); ?>" data-bs-toggle="tooltip">
                      <img src="<?php echo site_url('assets/frontend/default-new/') ?>image/icon/eye.svg" alt="" />
                    </div>
                  ...
                  <div class="item">
                    <div class="icon" title="<?php echo get_phrase('Total lessons'); ?>" data-bs-toggle="tooltip">
                      <img src="<?php echo site_url('assets/frontend/default-new/') ?>image/icon/play.svg" alt="" />
                    </div>
...
<section class="pb-110">
  <div class="container">
    ...
    <div class="pb-50"></div>
    <div class="about-img"><img src="<?php echo site_url('assets/frontend/default-new/') ?>image/identity-us-4.jpeg" alt="" /></div>
  </div>
</section>
<!-- End Our identity -->
      ...
      foreach ($latest_courses as $key => $latest_course) :
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($latest_course['title'])) . '/' . $latest_course['id']); ?>" class="course-item-one">
            <div class="img-rating">
              <div class="img"><img src="<?php echo $this->crud_model->get_course_thumbnail_url($latest_course['id']); ?>" alt="" /></div>
              <div class="rating">
                <p class="no"><?php echo $average_ceil_rating; ?></p>
                <span><img src="<?php echo site_url('assets/frontend/default-new/') ?>image/icon/star.svg" alt="" /></span>
              </div>
      ...
      <?php foreach($top_instructor_ids as $top_instructor_id):
        ...
        <div class="col-lg-4 col-md-6 col-sm-6">
          <div class="instructor-item">
            <div class="img"><img src="<?php echo $this->user_model->get_user_image_url($top_instructor['id']); ?>" alt="" /></div>
            <div class="content">
...
<section class="pb-110">
  <div class="container">
    <div class="row flex-column-reverse flex-lg-row align-items-center">
      ...
      <div class="col-lg-5">
        <div class="faq-img"><img src="<?php echo site_url('assets/frontend/default-new/') ?>image/faq.png" alt="" /></div>
      </div>
    </div>
  </div>
</section>
