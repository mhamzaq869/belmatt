  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-4 col-sm-4 col-4">
        <h1>
          <?php echo site_phrase('useful_links'); ?>
        </h1>
        <ul>
          <li><a
              href="<?php echo site_url('blog'); ?>"><?php echo ucwords(site_phrase('blog')); ?></a>
          </li>
          <li><a
              href="<?php echo site_url('home/courses'); ?>"><?php echo ucwords(site_phrase('all_courses')); ?></a>
          </li>
          <li><a
              href="<?php echo site_url('sign_up'); ?>"><?php echo ucwords(site_phrase('sign_up')); ?></a>
          </li>
      ...
      <div class="col-lg-2 col-md-4 col-sm-4 col-4">
        ...
        <ul>
          <li><a
              href="<?php echo site_url('home/contact_us'); ?>"><?php echo ucwords(site_phrase('contact_us')); ?></a>
          </li>
          <li><a
              href="<?php echo site_url('home/about_us'); ?>"><?php echo ucwords(site_phrase('about_us')); ?></a>
          </li>
          <li><a
              href="<?php echo site_url('home/privacy_policy'); ?>"><?php echo ucwords(site_phrase('privacy_policy')); ?></a>
          </li>
          <li><a
              href="<?php echo site_url('home/terms_and_condition'); ?>"><?php echo ucwords(site_phrase('terms_and_condition')); ?></a>
          </li>
          <li><a
              href="<?php echo site_url('home/faq'); ?>"><?php echo ucwords(site_phrase('FAQs')); ?></a>
          </li>
          <li><a
              href="<?php echo site_url('home/refund_policy'); ?>"><?php echo ucwords(site_phrase('refund_policy')); ?></a>
          </li>
        </ul>
      </div>
