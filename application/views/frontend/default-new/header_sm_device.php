            ...
            <li class="bg-light">
              ...
              <div class="collapse" id="ebook-category-collapse">
                ...
                foreach ($ebook_categories as $key => $ebook_category):?>
                  <li>
                    <a href="<?php echo site_url('ebook?category='.$ebook_category['slug'].'&price=all&rating=all') ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-15px fw-400"> <?php echo $ebook_category['title']; ?></a>
                  </li>
                  <?php endforeach; ?>
                  <li>
                    <a href="<?php echo site_url('ebook') ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-15px fw-400"> <i class="fas fa-list me-2"></i> <?php echo get_phrase('All Ebooks'); ?></a>
                  </li>
                </ul>
              </div>
            </li>
